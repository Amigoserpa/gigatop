...
2. Verify the branch head and approved-release ancestry using `HERMES_FETCH.md` and `PRE_DEPLOY_CHECKS.json`.
...
6. Promote the verified handoff commit to `main` only through the owner's approved repository process. Do not edit source during promotion.
